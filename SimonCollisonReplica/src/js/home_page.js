...
templates['home_page'] = template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "\r\n"
    + ((stack1 = container.invokePartial(lookupProperty(partials,"home_layout"),depth0,{"name":"home_layout","data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "    \r\n";
