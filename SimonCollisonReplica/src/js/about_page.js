...
templates['about_page'] = template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "\r\n"
    + ((stack1 = container.invokePartial(lookupProperty(partials,"about_layout"),depth0,{"name":"about_layout","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "\r\n";
